...
DNS Migration Utility atomic skill. Extracts DNS rewrites, hosts lists, and zone files from legacy resolvers (AdGuard Home, Pi-hole, bind9) and prepares them for authoritative Technitium DNS integration.
...
- Output lists of type: `{"domain": "service.example.invalid", "type": "A", "value": "[REDACTED_IPV4]", "ttl": 3600}`
